...
Public Class Boleta_credito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_ventas.Boleta_credito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBoleta_credito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Boleta_credito = New Boleta_credito()
        rpt.Site = Me.Site
        Return rpt
    End Function
