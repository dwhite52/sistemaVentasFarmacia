...
Public Class ventas_realziadas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_ventas.ventas_realziadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventas_realziadas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ventas_realziadas = New ventas_realziadas()
        rpt.Site = Me.Site
        Return rpt
    End Function
