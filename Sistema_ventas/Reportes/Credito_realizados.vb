...
Public Class Credito_realizados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_ventas.Credito_realizados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCredito_realizados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Credito_realizados = New Credito_realizados()
        rpt.Site = Me.Site
        Return rpt
    End Function
